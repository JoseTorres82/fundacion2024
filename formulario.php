...
<style> body { background-image: url('img/hero1.jpg'; opacity:50%;); background-size: cover;  background-repeat: no-repeat;  background-attachment: fixed; background-position: center;} </style>
  ...
  <body class="container" background="img/hero1.jpg">
    ...
    <?php menu(); ?>
    <!-- Título de la página -->
    <div class="alert_home alalert_home alert alert-primary text-center fst-italic" role="alert">
    ...
    <!-- Fila 1 -->
     <div class="row">
        ...
        <div class="col-4">
            ...
            <form class="form_label" action="formulario_destino.php" method="POST">    
                <div class="mb-3">
